...
// spec-scoped outputs (e.g. python-fastapi -- no migration, no recover()) simply produces no
// artifact items here at all, which is correct: there is nothing to check.
