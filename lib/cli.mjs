...
export const COMMANDS = {
	...
	'webgame scan': {
		usage: 'bskel webgame scan [--json]',
		options: { json: { type: 'boolean', default: false } },
	},
	'webgame contract verify': {
		usage: 'bskel webgame contract verify --feature <id> [--json]',
		options: {
			feature: { type: 'string', default: null, required: true },
			json: { type: 'boolean', default: false },
		},
	},
	'webgame contract emit': {
		usage: 'bskel webgame contract emit --feature <id> [--out <path>] [--json]',
		options: {
			feature: { type: 'string', default: null, required: true },
			out: { type: 'string', default: null },
			json: { type: 'boolean', default: false },
