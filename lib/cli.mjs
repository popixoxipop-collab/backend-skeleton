...
export const COMMANDS = {
	...
	'scan cross-feature-check': {
		usage: 'bskel scan cross-feature-check --feature <id> [--json]',
		options: {
			feature: { type: 'string', default: null, required: true },
			json: { type: 'boolean', default: false },
		},
	...
	'scan cross-feature-waive': {
		usage: 'bskel scan cross-feature-waive --feature <id> --signal resource_type|table|operation_id --identifier <name> --other-feature <id> --reason "..." [--json]',
		options: {
			feature: { type: 'string', default: null, required: true },
	...
	'patch apply': {
		usage: 'bskel patch apply --feature <id> --transaction <id> [--confirm <id>] [--json]',
		options: {
			feature: { type: 'string', default: null, required: true },
			transaction: { type: 'string', default: null, required: true },
			// D-ddl-apply: required (and must equal --transaction exactly) for any kind other than
			// config-apply -- checked by hand inside cmdPatchApply once the transaction's own kind
			// is known, not declaratively here. Ignored for config-apply.
	...
	serve: {
		usage: 'bskel serve [--port N] [--host <addr>] [--database-url-env <NAME> [--schema public] [--sign-key <path>]] [--json]',
		options: {
