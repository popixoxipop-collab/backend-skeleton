...
export const COMMANDS = {
	...
	'patch propose': {
		usage: 'bskel patch propose --feature <id> --choice <stackChoiceId> --target <config_check target path> [--json]',
		options: {
			feature: { type: 'string', default: null, required: true },
			choice: { type: 'string', default: null, required: true },
	...
	'patch apply': {
		usage: 'bskel patch apply --feature <id> --transaction <id> [--json]',
		options: {
			feature: { type: 'string', default: null, required: true },
			transaction: { type: 'string', default: null, required: true },
			json: { type: 'boolean', default: false },
