...
export const COMMANDS = {
	...
	'gameplay plan': {
		usage: 'bskel gameplay plan [--loop <id>] [--json]',
		options: {
			loop: { type: 'string', default: null },
			json: { type: 'boolean', default: false },
		},
	},
	'gameplay emit': {
		usage: 'bskel gameplay emit --loop <id> [--apply --reason "..." --unreal-editor <file> [--resume]] [--nullrhi] [--python <file>] [--timeout-sec N] [--json]',
		options: {
			loop: { type: 'string', default: null, required: true },
			apply: { type: 'boolean', default: false },
			resume: { type: 'boolean', default: false },
			reason: { type: 'string', default: '' },
			'unreal-editor': { type: 'string', default: null },
			nullrhi: { type: 'boolean', default: false },
			python: { type: 'string', default: 'python' },
			'timeout-sec': { type: 'string', default: '120', numeric: { min: 1, max: 900 } },
			json: { type: 'boolean', default: false },
		},
	},
	'handles emit': {
