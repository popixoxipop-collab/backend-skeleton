...
2. Extend package-manifest/install tests so the exact SDK modules and six JSON Schemas are present.
...
the documented public SDK entry point and load all six schema files. Source-checkout success is not
a substitute.
